...
| T4 | [Los monstruos no disparan las trampas ocultas](tareas/T4-monstruos-y-trampas.md) | — | **`reducer.ts`** | pendiente · la regla está en `main` desde `8b0b7dc`, le faltan sus tests |
