...
**Libres por estado:** 22, 36, 37, 39, 44 y 58 (MEDIO); 45 (ALTO). **48, 49, 52 y 57 acaban
de cerrarse (LISTA)**; 51 y 56 tienen reclamo vivo (ver la tabla).
...
tiene reclamo vivo ahora mismo). **39** y **44** también libres y sin choque EN CURSO.
Dicho llanamente: **con 51 y 56 ya cogidas (y 48, 49, 52, 57 recién cerradas), quedan
libres sin chocar entre sí 36→22, 58→37 (en cuanto cierren 51 y 54), 39, 44 y 45**. 15
...
51 → 53 → 54 → 55 sigue siendo de una en una, según cierre cada tramo.
